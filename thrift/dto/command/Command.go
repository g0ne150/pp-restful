...
func (p *TActiveThreadDump) writeField1(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("execTime", thrift.I64, 1); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:execTime: ", p), err) }
  if err := oprot.WriteI64(int64(p.ExecTime)); err != nil {
...
func (p *TActiveThreadDump) writeField2(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("threadDump", thrift.STRUCT, 2); err != nil {
...
func (p *TCmdActiveThreadDumpRes)  ReadField1(iprot thrift.TProtocol) error {
  ...
  p.ThreadDumps =  tSlice
  for i := 0; i < size; i ++ {
    _elem5 := &TActiveThreadDump{}
    if err := _elem5.Read(iprot); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", _elem5), err)
    }
    p.ThreadDumps = append(p.ThreadDumps, _elem5)
  }
  if err := iprot.ReadListEnd(); err != nil {
    return thrift.PrependError("error reading list end: ", err)
  }
